 ...
 * @LastEditTime: 2021-02-20 19:17:23
 * @LastEditors: Xu.WANG
 * @Description: 
 * @FilePath: \KiriCore\include\kiri_core\material\kiri_material_define.h
 */

#ifndef _KIRI_MATERIAL_DEFINE_H_
#define _KIRI_MATERIAL_DEFINE_H_
#pragma once
