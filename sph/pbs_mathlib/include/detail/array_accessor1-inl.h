#ifndef _DETAIL_ARRAY_ACCESSOR1_INL_H_
#define _DETAIL_ARRAY_ACCESSOR1_INL_H_
...
void ArrayAccessor<T, 1>::parallelForEach(Callback func) {
    parallelFor(Constants::kZeroSize, size(), [&](size_t i) {
        func(at(i));
    });
}
...
void ArrayAccessor<T, 1>::parallelForEachIndex(Callback func) const {
    parallelFor(Constants::kZeroSize, size(), func);
}
...
#endif  // _DETAIL_ARRAY_ACCESSOR1_INL_H_
